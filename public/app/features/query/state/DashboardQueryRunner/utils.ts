...
import { AnnotationEvent, AnnotationQuery, DataFrame, DataFrameView, DataSourceApi, logError } from '@grafana/data';
...
function notifyWithError(title: string, err: any) {
  ...
  logError('handleAnnotationQueryRunnerError', error);
