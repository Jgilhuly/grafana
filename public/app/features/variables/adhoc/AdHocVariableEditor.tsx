...
import { AdHocVariableModel, DataSourceInstanceSettings, getDataSourceRef, logError } from '@grafana/data';
...
const mapStateToProps = (state: StoreState, ownProps: OwnProps) => {
  ...
  if (!rootStateKey) {
    logError('AdHocVariableEditor: variable has no rootStateKey');
    return {
