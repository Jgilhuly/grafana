...
import { DataSourceVariableModel, logError, SelectableValue, VariableWithMultiSupport } from '@grafana/data';
...
const mapStateToProps = (state: StoreState, ownProps: OwnProps) => {
  ...
  if (!rootStateKey) {
    logError('DataSourceVariableEditor: variable has no rootStateKey');
    return {
