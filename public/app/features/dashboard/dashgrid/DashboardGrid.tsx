...
const logger = createMonitoringLogger('features.dashboard.dashgrid');
...
export class DashboardGrid extends PureComponent<Props, State> {
  ...
  buildLayout() {
    ...
    for (const panel of this.props.dashboard.panels) {
      ...
      if (!panel.gridPos) {
        logger.logWarning('Panel missing gridPos, skipping in layout', { panelId: panel.id, panelType: panel.type });
        continue;
      }
