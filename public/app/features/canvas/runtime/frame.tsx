...
import { canvasLogger } from 'app/core/utils/logging';
    ...
    switch (action) {
      ...
      case LayerActionID.Duplicate:
        if (element.item.id === 'frame') {
          canvasLogger.logDebug('Frame duplication not supported yet', { action, elementId: element.item.id });
          return;
        }
      ...
      default:
        canvasLogger.logDebug('Unhandled layer action', { action, elementId: element.item.id });
        return;
    }
  };
