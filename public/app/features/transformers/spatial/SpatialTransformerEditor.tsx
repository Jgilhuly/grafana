...
const log = createStructuredLogger('public.app.features.transformers.spatial.SpatialTransformerEditor');
...
export const SetGeometryTransformerEditor = (props: Props) => {
  ...
  useEffect(() => {
    if (!props.options.source?.mode) {
      ...
      log.debug('Initialized spatial transformer options', { options: opts });
    }
