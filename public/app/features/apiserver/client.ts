...
import { isLiveChannelMessageEvent, LiveChannelScope, logError, logWarning } from '@grafana/data';
      ...
      .pipe(
        ...
        map((line) => {
          try {
            ...
            logWarning('Invalid JSON in watch stream:', e, line);
            return null;
          }
        }),
        ...
        catchError((error) => {
          logError('Watch stream error:', error);
          throw error;
        })
      );
  }
