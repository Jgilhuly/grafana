...
try {
  ...
  console.info(JSON.stringify({ level: 'info', message: 'Label keys', context: { labelKeys } }));
} catch (error) {
...
try {
  ...
  console.info(JSON.stringify({ level: 'info', message: 'Label values', context: { values } }));
} catch (error) {
...
try {
  ...
  console.info(JSON.stringify({ level: 'info', message: 'Series labels', context: { labels } }));
} catch (error) {
...
try {
  ...
  console.info(JSON.stringify({ level: 'info', message: 'Parser and label keys', context: { parserAndLabelKeys } }));
} catch (error) {
