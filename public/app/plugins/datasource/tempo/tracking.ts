...
import { getTemplateSrv, logError, reportInteraction } from '@grafana/runtime';
...
export const onDashboardLoadedHandler = ({
  ...
  try {
    ...
    logError(error instanceof Error ? error : new Error('error in tempo tracking handler: ' + String(error)));
  }
};
