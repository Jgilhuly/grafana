...
const logger = createMonitoringLogger('canvas.connections2');
...
export class Connections2 {
  ...
  handleMouseEnter = (event: React.MouseEvent) => {
    ...
    if (!element) {
      logger.logDebug('No element found for connection action');
      return;
    }
    ...
    if (this.isDrawingConnection) {
      ...
      if (!this.connectionSource) {
        logger.logDebug('No connection source found');
        return;
      }
    }
