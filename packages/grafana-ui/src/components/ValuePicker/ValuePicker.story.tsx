...
const logger = createStructuredLogger('grafana-ui.story.value-picker');
...
export const Simple: StoryFn<typeof ValuePicker> = (args) => {
  return (
    <div style={{ width: '200px' }}>
      <ValuePicker {...args} options={options} onChange={(v) => logger.logInfo('Value picker changed', { value: v })} />
    </div>
  );
};
Simple.args = {
