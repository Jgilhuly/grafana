...
if (require.main === module) {
  (async () => {
    try {
      console.info(`📋 Generating files ↔ teams manifests from ${RAW_AUDIT_JSONL_PATH} ...`);
      ...
      console.info('✅ Manifest files generated:');
      console.info(`   • ${CODEOWNERS_JSON_PATH}`);
      console.info(`   • ${CODEOWNERS_BY_FILENAME_JSON_PATH}`);
      console.info(`   • ${FILENAMES_BY_CODEOWNER_JSON_PATH}`);
    } catch (e) {
      console.error(e);
      process.exit(1);
    }
