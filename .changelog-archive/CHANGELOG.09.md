...
<ClipboardButton
  {/*other props... */}
  onClipboardCopy={(e) => {
    console.info(JSON.stringify({ level: 'info', message: 'Text copied', context: { text: e.text } }));
  }}
/>
```
...
<ClipboardButton
  ...
  onClipboardCopy={(copiedText) => {
    console.info(JSON.stringify({ level: 'info', message: 'Text copied', context: { text: copiedText } }));
  }}
/>
```
